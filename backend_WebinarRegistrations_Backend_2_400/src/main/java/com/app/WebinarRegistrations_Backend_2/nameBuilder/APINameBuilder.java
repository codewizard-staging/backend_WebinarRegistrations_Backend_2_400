package com.app.WebinarRegistrations_Backend_2.nameBuilder;
...
public class APINameBuilder implements JPAEdmNameBuilder {
	...
	public String buildEntitySetName(final String entityTypeName) {
    	...
    	eSetName = "Webinar".equals(entityTypeName) ? "Webinars" : defaultNameBuilder.buildEntitySetName(entityTypeName);
        return eSetName;
    }
